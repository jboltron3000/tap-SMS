...
def sync_lists(ctx):
    ...
    url = "https://www.smssoftware.net/tms/manTrafExp?fromDate=" + str(end_date) + "&toDate=" + str(start_date) + "&interval=0&hours=0&reqType=tdd&apiKey=" + str(apiKey) + "&locationId=TLS000"
